  ...
  return (
    <>
      <section className="my-12">
        <div className="h-[50vh] relative w-full bg-[url(/images/banners/arc_new_phone_male_banner.jpg)] lg:bg-[url(/images/banners/new_arc_male_banner.png)] bg-no-repeat bg-cover">
